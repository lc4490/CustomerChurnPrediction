...
def explain_prediction(probability, input_dict, surname):
  ...
  Here are the machine learning model's top 10 most important features for predicting churn:
            ...
            Feature | Importance
  ------------------------------------
      NumOfProducts | 0.032888
     IsActiveMember | 0.164146
                Age | 0.109550
  Geography_Germany | 0.91373
            Balance | 0.052786
  ...
  Don't mention the probability of churning, or the machien learning model, or say anything like "Based on the machine learning model's prediction and top 10 most important features, just explain the predction.
  """
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  Her is the customer's information:
  {input_dict}
